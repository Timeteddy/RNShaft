...
/// 醫生0
/// </summary>
public class Doctors_five : NPC
{
    #region 宣告
    [Header("負責的病人")]
    public Patient_five patint;
    ...
    {
        GM.onSetReadlyDialogue("DcotorsFive");
    }
    #endregion
    ...
    {
        if (GM.onGetSceneState() != SceneState.fiveStart) return;
    ...
    {
        if (GM.onGetDialoguePeople() != "DcotorsFive") return;
