...
/// 醫生0
/// </summary>
public class Doctors_one : NPC
{
    #region 宣告
    [Header("負責的病人")]
    public Patient_one patint;
    ...
    {
        GM.onSetReadlyDialogue("DcotorsOne");
    }
    #endregion
    ...
    {
        if (GM.onGetSceneState() != SceneState.oneStart) return;
    ...
    {
        if (GM.onGetDialoguePeople() != "DcotorsOne") return;
