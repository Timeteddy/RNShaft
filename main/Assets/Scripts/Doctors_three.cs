...
/// 醫生0
/// </summary>
public class Doctors_three : NPC
{
    #region 宣告
    [Header("負責的病人")]
    public Patient_three patint;
    ...
    {
        GM.onSetReadlyDialogue("DcotorsThree");
    }
    #endregion
    ...
    {
        if (GM.onGetSceneState() != SceneState.threeStart) return;
    ...
    {
        if (GM.onGetDialoguePeople() != "DcotorsThree") return;
